...
public class FBFloatingMenusActivity extends AppCompatActivity {
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        programFab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(FBFloatingMenusActivity.this, programFab1.getLabelText(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        menu2.setOnMenuToggleListener(new FloatingActionMenu.OnMenuToggleListener() {
            ...
            public void onMenuToggle(boolean opened) {
                ...
                Toast.makeText(FBFloatingMenusActivity.this, text, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        findViewById(R.id.fab_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FBFloatingMenusActivity.this, FBRecyclerViewActivity.class));
            }
        });
